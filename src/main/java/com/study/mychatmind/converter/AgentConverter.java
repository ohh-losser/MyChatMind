package com.study.mychatmind.converter;
...
public class AgentConverter {
    ...
    public AgentDTO toDTO(CreateAgentRequest request) {
        ...
        return AgentDTO.builder()
                ...
                .allowedTools(request.getAllowedTools() != null ? request.getAllowedTools() : java.util.Collections.emptyList())
                .allowedKbs(request.getAllowedKbs() != null ? request.getAllowedKbs() : java.util.Collections.emptyList())
                .chatOptions(request.getChatOptions() != null ? request.getChatOptions() : AgentDTO.ChatOptions.defaultOptions())
                .build();
    }
